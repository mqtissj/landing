...
// Sourced from the cult-ui registry (@cult-ui/squiggle-arrow). Self-contained
// and already themed via `currentColor`, so it needed no restyling to fit
// this site's marker/sticker doodle motif — just pass a text-* color class.
